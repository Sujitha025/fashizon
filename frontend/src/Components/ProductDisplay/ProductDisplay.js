    ...
    <div className='productdisplay'>
        ...
        <div className='productdisplay-right'>
            ...
            <div className='productdisplay-right-description'>
                A lightweight,usually knitted,pullover shirt,close-fitting and pullover,close-fitting and with a round neckline and short sleeves,worn as an undershirt or outer garment
            </div>
